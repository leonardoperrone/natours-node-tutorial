...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibGlveDIwMTIiLCJhIjoiY2swdTJyMXRyMGk5bjNncDZvd3I2N3h5ZSJ9.zCwRR6_f0-TrhU7JK0CWow';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.dat, ": ").concat(loc.description, "</p>")).addTo(map); // Extends map bounds to include current location
...
var stripe = Stripe('pk_test_i2Uk5gWZekUhmfnfOXOKpLoP000LyXmk4Z');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            console.log(session); // 2. Create checkout form + charge credt card
